  ...
  return (
    <>
      ...
      <aside className="fixed left-0 top-0 hidden h-full w-64 border-r border-slate-200 bg-white p-6 lg:block dark:bg-slate-800 dark:text-white dark:border-slate-700">
        <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-400">Analytics</h1>
        <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">Dashboard empresarial</p>
